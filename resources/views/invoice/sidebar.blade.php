  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" data-bs-target="#invoice-nav" data-bs-toggle="collapse" href="#">
        <i class="bi bi-menu-button-wide"></i><span>Invoice Management</span><i class="bi bi-chevron-down ms-auto"></i>
      </a>
   ...
   <!-- End Tables Nav -->
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" data-bs-target="#planning-nav" data-bs-toggle="collapse" href="#">
        <i class="bi bi-bar-chart"></i><span>Planning</span><i class="bi bi-chevron-down ms-auto"></i>
      </a>
      <ul id="planning-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        <li>
          <a href="planning.goal-setting">
            <i class="bi bi-circle"></i><span>Goal Setting</span>
          </a>
        </li>
        <li>
